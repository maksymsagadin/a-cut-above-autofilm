...
const FeaturedPosts = () => {
  ...
  return (
    <div className="mb-8">
      <Carousel infinite={true} autoPlay={true} autoPlaySpeed={2000} customTransition={'transform 1000ms ease-in-out'} transitionDuration={1000} arrows={true}  responsive={responsive} itemClass="px-4" >
