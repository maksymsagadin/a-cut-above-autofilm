...
const FeaturedPosts = () => {
  ...
  return (
    <div className="mb-8">
      <Carousel infinite={true} autoPlay={true} autoPlaySpeed={4000} customTransition={'transform 2500ms ease-in-out'} transitionDuration={2500} arrows={true}  responsive={responsive} itemClass="px-4" >
