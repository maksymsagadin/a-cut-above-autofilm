...
const FeaturedPosts = () => {
  ...
  return (
    <div className="mb-8">
      <Carousel infinite={true} autoPlay={true} autoPlaySpeed={2500} customTransition={'transform 2000ms ease-in-out'} transitionDuration={2000} arrows={true}  responsive={responsive} itemClass="px-4" >
