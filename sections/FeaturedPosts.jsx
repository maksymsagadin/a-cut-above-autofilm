...
const FeaturedPosts = () => {
  ...
  return (
    <div className="mb-8 ">
      <Carousel infinite={true} centerMode={true} keyBoardControl={true} autoPlay={true} autoPlaySpeed={2500} customLeftArrow={customLeftArrow} customRightArrow={customRightArrow} responsive={responsive} itemClass="px-4" >
